...
test "$(awk '$1 == "acl" && ($2 == "codex_clients" || $2 == "antigravity_clients" || $2 == "codex_upstreams" || $2 == "antigravity_upstreams") { print }' "$egress_config")" = \
    "$(printf '%s\n' \
        ...
        'acl antigravity_upstreams dstdomain accounts.google.com oauth2.googleapis.com www.googleapis.com cloudcode-pa.googleapis.com daily-cloudcode-pa.googleapis.com lh3.googleusercontent.com')" || \
